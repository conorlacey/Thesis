...
saveRDS(dat_dMACS, file = "data/dat_dMACS.Rev.RDS")
saveRDS(dat_dMACS_low_CI, file = "data/dat_dMACS_low.Rev.RDS")
saveRDS(dat_dMACS_high_CI, file = "data/dat_dMACS_high.Rev.RDS")

saveRDS(dat_dMACS_post, file = "data/dat_dMACS_post.Rev.RDS")
saveRDS(dat_dMACS_low_CRI, file = "data/dat_dMACS_low_CRI.Rev.RDS")
saveRDS(dat_dMACS_high_CRI, file = "data/dat_dMACS_high_CRI.Rev.RDS")

saveRDS(dat_dMACS_S, file = "data/dat_dMACS_S.Rev.RDS")
saveRDS(dat_dMACS_S_low, file = "data/dat_dMACS_S_low.Rev.RDS")
saveRDS(dat_dMACS_S_high, file = "data/dat_dMACS_S_high.Rev.RDS")
