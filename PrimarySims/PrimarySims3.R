...
for (i in 1:500){
  for (cond in 1:54){
    ...
    if (cond %in% c(31,32,33,40,41,42,49,50,51)){ #dMACS 0.5 mean unequal
      ...
      int.R <- 0 #intercept for reference group
      int.F <- 0.5 #intercept for focal group
    }
...
saveRDS(dat_dMACS, file = "data/dat_dMACS.3.RDS")
saveRDS(dat_dMACS_low_CI, file = "data/dat_dMACS_low.3.RDS")
saveRDS(dat_dMACS_high_CI, file = "data/dat_dMACS_high.3.RDS")

saveRDS(dat_dMACS_post, file = "data/dat_dMACS_post.3.RDS")
saveRDS(dat_dMACS_low_CRI, file = "data/dat_dMACS_low_CRI.3.RDS")
saveRDS(dat_dMACS_high_CRI, file = "data/dat_dMACS_high_CRI.3.RDS")

saveRDS(dat_dMACS_S, file = "data/dat_dMACS_S.3.RDS")
saveRDS(dat_dMACS_S_low, file = "data/dat_dMACS_S_low.3.RDS")
saveRDS(dat_dMACS_S_high, file = "data/dat_dMACS_S_high.3.RDS")
