...
for (i in 1:500){
  for (cond in 1:54){
    ...
    if (cond %in% c(34,35,36,43,44,45,52,53,54)){ #dMACS 0.4 mean unequal
      ...
      int.R <- 0 #intercept for reference group
      int.F <- 0.35 #intercept for focal group
    }
...
saveRDS(dat_dMACS, file = "data/dat_dMACS.4.RDS")
saveRDS(dat_dMACS_low_CI, file = "data/dat_dMACS_low.4.RDS")
saveRDS(dat_dMACS_high_CI, file = "data/dat_dMACS_high.4.RDS")

saveRDS(dat_dMACS_post, file = "data/dat_dMACS_post.4.RDS")
saveRDS(dat_dMACS_low_CRI, file = "data/dat_dMACS_low_CRI.4.RDS")
saveRDS(dat_dMACS_high_CRI, file = "data/dat_dMACS_high_CRI.4.RDS")

saveRDS(dat_dMACS_S, file = "data/dat_dMACS_S.4.RDS")
saveRDS(dat_dMACS_S_low, file = "data/dat_dMACS_S_low.4.RDS")
saveRDS(dat_dMACS_S_high, file = "data/dat_dMACS_S_high.4.RDS")
