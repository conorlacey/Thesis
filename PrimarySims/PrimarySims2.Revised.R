...
saveRDS(dat_dMACS, file = "data/dat_dMACS.Rev2.RDS")
saveRDS(dat_dMACS_low_CI, file = "data/dat_dMACS_low.Rev2.RDS")
saveRDS(dat_dMACS_high_CI, file = "data/dat_dMACS_high.Rev2.RDS")

saveRDS(dat_dMACS_post, file = "data/dat_dMACS_post.Rev2.RDS")
saveRDS(dat_dMACS_low_CRI, file = "data/dat_dMACS_low_CRI.Rev2.RDS")
saveRDS(dat_dMACS_high_CRI, file = "data/dat_dMACS_high_CRI.Rev2.RDS")

saveRDS(dat_dMACS_S, file = "data/dat_dMACS_S.Rev2.RDS")
saveRDS(dat_dMACS_S_low, file = "data/dat_dMACS_S_low.Rev2.RDS")
saveRDS(dat_dMACS_S_high, file = "data/dat_dMACS_S_high.Rev2.RDS")
