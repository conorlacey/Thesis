...
for (i in 1:500){
  for (cond in 1:54){
    ...
    if (cond %in% c(7,8,9,16,17,18,25,26,27,
                    34,35,36,43,44,45,52,53,54)){ #dMACS 0.4 mean equal
      load.R <- .6 #loading for the reference group
      load.F <- .655#loading for focal group
      int.R <- 0 #intercept for reference group
      int.F <- 0.39 #intercept for focal group
    }
...
saveRDS(dat_dMACS, file = "data/dat_dMACS.Rev4.RDS")
saveRDS(dat_dMACS_low_CI, file = "data/dat_dMACS_low.Rev4.RDS")
saveRDS(dat_dMACS_high_CI, file = "data/dat_dMACS_high.Rev4.RDS")

saveRDS(dat_dMACS_post, file = "data/dat_dMACS_post.Rev4.RDS")
saveRDS(dat_dMACS_low_CRI, file = "data/dat_dMACS_low_CRI.Rev4.RDS")
saveRDS(dat_dMACS_high_CRI, file = "data/dat_dMACS_high_CRI.Rev4.RDS")

saveRDS(dat_dMACS_S, file = "data/dat_dMACS_S.Rev4.RDS")
saveRDS(dat_dMACS_S_low, file = "data/dat_dMACS_S_low.Rev4.RDS")
saveRDS(dat_dMACS_S_high, file = "data/dat_dMACS_S_high.Rev4.RDS")
