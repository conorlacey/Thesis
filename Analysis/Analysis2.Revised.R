...
# Read in Data ------------------------------------------------------------
dMACS <- read_rds("data/dat_dMACS.Rev2.RDS")
dMACS_low <- read_rds("data/dat_dMACS_low.Rev2.RDS")
dMACS_high <- read_rds("data/dat_dMACS_high.Rev2.RDS")

dMACS_post <- read_rds("data/dat_dMACS_post.Rev2.RDS")
dMACS_low_CRI <- read_rds("data/dat_dMACS_low_CRI.Rev2.RDS")
dMACS_high_CRI <- read_rds("data/dat_dMACS_high_CRI.Rev2.RDS")

dMACS_S <- read_rds("data/dat_dMACS_S.Rev2.RDS")
dMACS_s_low <- read_rds("data/dat_dMACS_S_low.Rev2.RDS")
dMACS_s_high <- read_rds("data/dat_dMACS_S_high.Rev2.RDS")
