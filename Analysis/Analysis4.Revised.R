...
# Read in Data ------------------------------------------------------------
dMACS <- read_rds("data/dat_dMACS.Rev4.RDS")
dMACS_low <- read_rds("data/dat_dMACS_low.Rev4.RDS")
dMACS_high <- read_rds("data/dat_dMACS_high.Rev4.RDS")

dMACS_post <- read_rds("data/dat_dMACS_post.Rev4.RDS")
dMACS_low_CRI <- read_rds("data/dat_dMACS_low_CRI.Rev4.RDS")
dMACS_high_CRI <- read_rds("data/dat_dMACS_high_CRI.Rev4.RDS")

dMACS_S <- read_rds("data/dat_dMACS_S.Rev4.RDS")
dMACS_s_low <- read_rds("data/dat_dMACS_S_low.Rev4.RDS")
dMACS_s_high <- read_rds("data/dat_dMACS_S_high.Rev4.RDS")
