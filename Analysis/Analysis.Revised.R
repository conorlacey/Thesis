...
# Read in Data ------------------------------------------------------------
dMACS <- read_rds("data/dat_dMACS.Rev.RDS")
dMACS_low <- read_rds("data/dat_dMACS_low.Rev.RDS")
dMACS_high <- read_rds("data/dat_dMACS_high.Rev.RDS")

dMACS_post <- read_rds("data/dat_dMACS_post.Rev.RDS")
dMACS_low_CRI <- read_rds("data/dat_dMACS_low_CRI.Rev.RDS")
dMACS_high_CRI <- read_rds("data/dat_dMACS_high_CRI.Rev.RDS")

dMACS_S <- read_rds("data/dat_dMACS_S.Rev.RDS")
dMACS_s_low <- read_rds("data/dat_dMACS_S_low.Rev.RDS")
dMACS_s_high <- read_rds("data/dat_dMACS_S_high.Rev.RDS")
...
View(dMACS_S_a[1] %>% round(digits = 2))
