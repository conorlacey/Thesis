...
# Read in Data ------------------------------------------------------------
dMACS <- read_rds("data/dat_dMACS.4.RDS")
dMACS_low <- read_rds("data/dat_dMACS_low.4.RDS")
dMACS_high <- read_rds("data/dat_dMACS_high.4.RDS")

dMACS_post <- read_rds("data/dat_dMACS_post.4.RDS")
dMACS_low_CRI <- read_rds("data/dat_dMACS_low_CRI.4.RDS")
dMACS_high_CRI <- read_rds("data/dat_dMACS_high_CRI.4.RDS")

dMACS_S <- read_rds("data/dat_dMACS_S.4.RDS")
dMACS_s_low <- read_rds("data/dat_dMACS_S_low.4.RDS")
dMACS_s_high <- read_rds("data/dat_dMACS_S_high.4.RDS")
